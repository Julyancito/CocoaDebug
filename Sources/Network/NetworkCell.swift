...
class NetworkCell: UITableViewCell {
    ...
    var httpModel: _HttpModel? {
        didSet {
            ...
            if httpModel?.isTag == true {
                self.contentView.backgroundColor = .cerulean
            }else{
                self.contentView.backgroundColor = .elephant
            }
            
            //isSelected
            if httpModel?.isSelected == true {
                statusCodeView.backgroundColor = "#115588".hexColor
            }else{
                statusCodeView.backgroundColor = "#115555".hexColor
            }
        }
    }
    ...
    override func awakeFromNib() {
        ...
        requestTimeTextView.textColor = UIColor.white
